...
class ArrayViewHelper extends AbstractViewHelper
{
    ...
    public static function renderStatic(
        ...
        /** @var ConfigurableDataProvider $dataProvider */
        $dataProvider = GeneralUtility::makeInstance(ConfigurableDataProvider::class);

        return $dataProvider->dataForObjects($data);
    }
}
